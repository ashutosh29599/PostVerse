...
class UserFetchingTest(APITestCase):
    ...
    def test_fetch_all_users_without_any_data_only(self):
        response = self.client.get(reverse('user-list'), data={
            'email': 'false',
            'first_name': 'False',
            'last_name': 'FALSE',
    ...
    def test_fetch_a_single_user_without_any_data_only(self):
        response = self.client.get(reverse('user-list'), data={
            'username': 'test_user',
            'email': 'false',
            'first_name': 'False',
    ...
    def test_fetch_all_users_with_similar_username_to_query_username_with_all_data(self):
        response = self.client.get(reverse('user-list'), data={
            'username': 'test_user',
            'similar': 'true',
            'email': 'true',
    ...
    def test_fetch_all_users_with_similar_username_to_query_username_without_any_data(self):
        response = self.client.get(reverse('user-list'), data={
            'username': 'test_user',
            'similar': 'true',
            'email': 'false',
